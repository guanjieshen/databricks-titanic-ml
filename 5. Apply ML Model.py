...
model_name = "emagine_titanic"
input_table_name = "emagine.titanic_test_features"
output_table = "emagine.titanic_result"
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.emagine_titanic"
